...
import static io.github.mavaze.mockserver.config.Constants.STUBS_CONFIG_FOLDER;
...
public class StubConfigProcessor {
	...
	public static List<StubConfig> read(final String configFile) {
		try (InputStream configStream = ApplicationUtils.getResourceAsStream(join(separator, STUBS_CONFIG_FOLDER, configFile))) {
